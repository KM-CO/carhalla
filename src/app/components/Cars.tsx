...
export default function Cars() {
    ...
    return (
        <div className="m-3 grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-3 items-center" >
            {cars.map((car: Car) => (
            ...
            <div className="flex border-3 border-neutral-500 items-center hover:border-neutral-700 justify-center h-[280px] w-[300px] m-auto">
